    ...
    <section className="mailer bg-gradient-to-b from-[#FFFFFF] to-[#E4FBFF]">
      <div className="flex flex-col pr-0 md:flex-row pt-20 justify-center md:pl-10">
        <div className="left pr-[38px] pl-[38px] w-full flex flex-col justify-start items-center md:w-1/2 md:pr-0 md:pl-0 md:items-start">
          ...
          <h2 className="text-xl lg:text-2xl text-(--candypink) font-absolute">Your Brand, In Every Hand</h2>
          ...
          <div className="flex flex-col gap-3 mt-5 md:mt-[20px]">
            <p className="text-[16px] lg:text-[18px] text-[#9C9C9C]" >WHY IT WORKS? </p>
            <ul className="flex flex-col gap-4">
              <li className='flex items-center gap-3' >
                ...
                <span className="item text-[16px] lg:text-[18px] font-satoshi-medium">Reach millions in minutes</span>
              </li>
              <li className='flex items-center gap-3' >
                <span className="ok w-[24px] min-w-[24px] h-[24px] bg-[var(--green)] rounded-full flex justify-center items-center">
                  <svg
                ...
                <span className="item text-[16px] lg:text-[18px] font-satoshi-medium">Target by channel: general trade, modern trade, corporate & more</span>
              </li>
              <li className='flex items-center gap-3'>
                <span className="ok w-[24px] min-w-[24px] h-[24px] bg-[var(--green)] rounded-full flex justify-center items-center">
                  <svg
                ...
                <span className="item text-[16px] lg:text-[18px] font-satoshi-medium">Trackable & measurable performance</span>
              </li>
              <li className='flex items-center gap-3' >
                <span className="ok w-[24px] min-w-[24px] h-[24px] bg-[var(--green)] rounded-full flex justify-center items-center">
                  <svg
                ...
                <span className="item text-[16px] lg:text-[18px] font-satoshi-medium">Unskippable, memorable, and right in their hand</span>
              </li>
            </ul>
          </div>
          </div>
          <div className="contents md:hidden" >
            <p className="text-lg text-center font-bold text-(--candypink) font-absolute" >Your Brand, In Every Hand</p>
            <h1 className="text-5xl text-center uppercase">
              <span className="text-[var(--blue)] font-absolute" >OG WTR turns every bottle into a high-impact ad.</span> 
            </h1>
            <p className="text-lg text-center font-satoshi-light mt-[20px] mb-[20px]">Reach your audience where it matters—stores, offices, gyms, campuses, events.</p>
            ...
            <button className="mt-9 w-[228px] h-[60px] cursor-pointer bg-cover text-white"  style={{ backgroundImage: `url(${button})` }} onClick={handleOverlay}>Collaborate with OG!</button>
        </div>
